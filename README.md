...
2026년은 시나리오 배경입니다. **실제 2026년 군 편제·배치·전력·시설 데이터베이스나 전쟁 예측 모델은 구현하지 않습니다.** 부대와 시설은 가상 배치이며, 성능·피해·주사위·지형·보급 수치는 게임 밸런스 값입니다. 실제 인명피해나 무기 위력을 산출하지 않습니다.
...
본 게임에 실제 군사 부대 데이터, 시설별 취약점, 표적 우선순위, 작전 계획 또는 실제 사상자 추정치는 포함되어 있지 않습니다.
