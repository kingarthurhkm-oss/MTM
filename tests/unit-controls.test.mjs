...
function ui(){
 ...
 const saved=new Map(),sandbox=vm.createContext({drawTerrain,Game,TYPES,SITE_TYPES,clamp,GEOGRAPHY,worldToScreen,screenToWorld,ARMY_DATA,ARMY_SCENARIO,armyFormation,armyChildren,armyTile,
